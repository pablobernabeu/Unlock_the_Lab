import{i as X,g as J,a as Z,r as f,s as b,o as A}from"./firebase-CqdP5AWb.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();const ee={apiKey:"AIzaSyCjLzq8QNQqhGOpTJy3tzwuQrovMm6Vdi4",authDomain:"unlock-the-lab-workshop.firebaseapp.com",databaseURL:"https://unlock-the-lab-workshop-default-rtdb.europe-west1.firebasedatabase.app",projectId:"unlock-the-lab-workshop",storageBucket:"unlock-the-lab-workshop.firebasestorage.app",messagingSenderId:"604889899913",appId:"1:604889899913:web:d46afe88111e8bcb7d3758",measurementId:"G-HSC51V3CLP"},F=X(ee),h=J(F);Z(F);let $=0,S=[],M=[],L=[],u=null,O={},te={},w=0,E="";const G=30*60*1e3,Y=5*60*1e3,B=50*60*1e3,ne=[15*60*1e3,5*60*1e3],oe=1*60*1e3;let P=null,r=G,v=null,T=null,R=[],k=[],H=new Set;const se={"STUDY-101":1,"STUDY-102":5,"STUDY-103":6,"STUDY-104":1,"STUDY-105":5,"STUDY-106":4,"STUDY-107":2,"STUDY-108":7,"STUDY-109":4,"STUDY-110":6,"STUDY-111":2,"STUDY-112":1,"STUDY-113":6,"STUDY-114":5,"STUDY-115":3,"STUDY-116":5,"STUDY-117":1,"STUDY-118":4,"STUDY-119":7,"STUDY-120":2,"STUDY-121":5,"STUDY-122":6,"STUDY-123":1},q=100;document.addEventListener("DOMContentLoaded",async()=>{const e=loadState();if(u||(u=ie()),E=localStorage.getItem("userName"),E||(E=ae(),localStorage.setItem("userName",E)),displayUsername(),re(),await ge(),pe(),fe(),he(),e&&Object.keys(O).length>0&&restoreSubmittedRatings(),ue(),me(),w>0){const t=document.getElementById("total-score-header");t&&(t.textContent=`Score: ${w}`,document.getElementById("score-banner").style.display="flex")}N(e?$:0)});window.nextPage=ye;window.previousPage=be;window.enableSubmit=ve;window.submitRating=$e;window.showHelp=we;window.closeHelp=Q;window.showTab=Ee;function ie(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}function ae(){const e=["Red","Blue","Green","Yellow","Purple","Orange","Pink","Teal","Brave","Wise","Swift","Tall","Happy","Clever","Bright","Quick","Mighty","Gentle","Bold","Cheerful","Curious","Friendly","Kind","Peaceful"],t=["Fox","Raccoon","Owl","Sparrow","Robin","Falcon","Eagle","Hawk","Rabbit","Squirrel","Deer","Bear","Wolf","Otter","Badger","Hedgehog","Dolphin","Seal","Penguin","Panda","Koala","Tiger","Lion","Leopard"],n=e[Math.floor(Math.random()*e.length)],o=t[Math.floor(Math.random()*t.length)];return`${n} ${o}`}function re(){P=Date.now(),r=G,U();const e=setInterval(()=>{Date.now()-P>=B&&clearInterval(e),U()},6e4);W(),z(),v=setTimeout(()=>{clearInterval(e),_()},r)}function W(){R.forEach(e=>clearTimeout(e)),R=[],ne.forEach(e=>{const t=r-e;if(t>0&&!H.has(e)){const n=setTimeout(()=>{ce(e),H.add(e)},t);R.push(n)}})}function z(){T&&clearTimeout(T);const e=r-oe;e>0&&r<B&&(T=setTimeout(()=>{le()},e))}function ce(e){const t=Math.floor(e/6e4);alert(`⏰ ${t} minutes remaining in your session.`)}function le(){if(!(r<B)){alert("⏰ Your session will end in 1 minute. This is the maximum session duration.");return}const t=Math.floor(r/6e4),n=Math.floor(B/6e4),o=Math.floor(Y/6e4);confirm(`⏰ Your ${t}-minute session will end in 1 minute.

Would you like to extend for ${o} more minutes?
(Maximum total: ${n} minutes)`)&&de()}function de(){v&&clearTimeout(v);const e=r+Y;r=Math.min(e,B),W(),z(),v=setTimeout(()=>{_()},r),U();const t=Math.floor((r-(e-Y))/6e4);t>0&&alert(`✅ Session extended! You have ${t} more minutes.`)}function U(){const e=Date.now()-P,t=r-e,n=Math.floor(t/6e4),o=document.getElementById("session-timer");o&&t>0?(o.textContent=`${n} min remaining`,t<=5*6e4?o.style.color="#f56565":t<=15*6e4?o.style.color="#fbbf24":o.style.color=""):o&&(o.textContent="Session ending...",o.style.color="#f56565")}function _(){if(k.forEach(n=>{typeof n=="function"&&n()}),k=[],u){const n=f(h,`active/${u}`);b(n,null)}v&&clearTimeout(v),T&&clearTimeout(T),R.forEach(n=>clearTimeout(n));const e=document.createElement("div");e.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
        ...
        text-align: center;
        padding: 20px;
    `;const t=Math.floor((Date.now()-P)/6e4);e.innerHTML=`
        <div>
